...
const props = defineProps<{ local: NetworkInfo; config: TestConfig; serverConfig: ServerConfig; current?: TestItem; points: MetricPoint[]; progress: number; elapsed: number; summary: TestSummary; connected: boolean; serverRunning: boolean; live?: boolean; completedLabel?: string }>()
